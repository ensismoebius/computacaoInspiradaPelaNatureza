...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENT03_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENT03_H_
	...
	class Experiment03 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment03_errors.csv");
				...
				unsigned int maxIt = 2400;
				unsigned int inputSize = 4;
				unsigned int outputSize = 3;
				unsigned int innerLayerSize = 4;
				...
				openFile("/tmp/neuralExperiments_Experiment03_results.csv");
