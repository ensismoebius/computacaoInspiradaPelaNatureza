...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt10_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt10_H_
	...
	class Experiment10 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment10_errors.csv");
				...
				openFile("/tmp/neuralExperiments_Experiment10_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt10_H_ */
