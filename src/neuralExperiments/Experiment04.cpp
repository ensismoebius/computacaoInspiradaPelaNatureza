...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt04_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt04_H_
	...
	class Experiment04 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment04_errors.csv");
				...
				unsigned int innerLayerSize = 16;
				...
				openFile("/tmp/neuralExperiments_Experiment04_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt04_H_ */
