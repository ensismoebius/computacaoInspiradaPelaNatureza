...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt09_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt09_H_
	...
	class Experiment09 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment09_errors.csv");
				...
				openFile("/tmp/neuralExperiments_Experiment09_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt09_H_ */
