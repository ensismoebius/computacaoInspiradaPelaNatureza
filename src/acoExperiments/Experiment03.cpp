 ...
 *
 */
#ifndef CLASS_ACOExperiment03_CPP_
#define CLASS_ACOExperiment03_CPP_
	...
	class Experiment03 {
		public:
			static void perform() {
				...
				map.saveBestPath(map.points[0], "/tmp/data03.csv");

				openFile("/tmp/p");
				writeCharsToFile("plot \"/tmp/data03.csv\" using 1:2:3:4 with vectors filled head lw 1");
				closeFile();
...
#endif /* CLASS_ACOExperiment03_CPP_ */
