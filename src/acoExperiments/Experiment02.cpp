 ...
 *
 */
#ifndef CLASS_ACOExperiment02_CPP_
#define CLASS_ACOExperiment02_CPP_
	...
	class Experiment02 {
		public:
			static void perform() {
				...
				map.saveBestPath(map.points[0], "/tmp/data02.csv");

				openFile("/tmp/p");
				writeCharsToFile("plot \"/tmp/data02.csv\" using 1:2:3:4 with vectors filled head lw 1");
				closeFile();
...
#endif /* CLASS_ACOExperiment02_CPP_ */
