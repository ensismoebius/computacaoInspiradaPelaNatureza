...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt05_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt05_H_
	...
	class Experiment05 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment05_errors.csv");
				...
				unsigned int innerLayerSize = 13;
				...
				openFile("/tmp/neuralExperiments_Experiment05_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt05_H_ */
