 ...
 *
 */
#ifndef CLASS_ACOExperiment04_CPP_
#define CLASS_ACOExperiment04_CPP_
	...
	class Experiment04 {
		public:
			static void perform() {
				...
				map.saveBestPath(map.points[0], "/tmp/data04.csv");

				openFile("/tmp/p");
				writeCharsToFile("plot \"/tmp/data04.csv\" using 1:2:3:4 with vectors filled head lw 1");
				closeFile();
...
#endif /* CLASS_ACOExperiment04_CPP_ */
