...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt08_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt08_H_
	...
	class Experiment08 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment08_errors.csv");
				...
				openFile("/tmp/neuralExperiments_Experiment08_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt08_H_ */
