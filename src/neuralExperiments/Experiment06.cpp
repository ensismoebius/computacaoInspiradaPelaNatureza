...
#ifndef SRC_NEURALEXPERIMENTS_EXPERIMENt06_H_
#define SRC_NEURALEXPERIMENTS_EXPERIMENt06_H_
	...
	class Experiment06 {
		public:
			...
			static void perform() {
				...
				openFile("/tmp/neuralExperiments_Experiment06_results.csv");
...
#endif /* SRC_NEURALEXPERIMENTS_EXPERIMENt06_H_ */
